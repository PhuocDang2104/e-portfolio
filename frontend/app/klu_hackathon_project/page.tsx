    ...
    <>
      ...
      <section className="hero project-hero reveal" id="home" aria-label="Project hero">
        <div className="page hero-inner">
          <div className="hero-left reveal">
            ...
            <h1 className="hero-title">SAVINA - Humanitarian Logistics AIoT System</h1>
            <p className="lead">
              AIoT & Humanitarian Logistics system for food distribution and relief: ESP32-CAM
              with Computer Vision for aerial human detection, K-Means clustering algorithm for
              resource allocation based on household data, priority, and location, and RFID for
            ...
            <div className="meta-row" aria-hidden="true">
              <div className="meta-pill">ESP32-cam · ESP8266 </div>
              <div className="meta-pill">RFID</div>
              <div className="meta-pill">WiFi · MQTT</div>
              <div className="meta-pill">Flask · PostgreSQL · Google Sheet</div>
              <div className="meta-pill">UART · SPI</div>
              <div className="meta-pill"> Computer Vision  ·  K-mean Clustering</div>
            </div>
          </div>

          <div className="hero-right reveal">
            <img
              src="../static/images/klu_hackathon/klu_hackathon_banner.jpg"
              alt="SCENT banner"
      ...
      <div className="page">
        <section id="overview" className="content reveal" aria-labelledby="overview-title">
          ...
          <p className="muted">
            SAVINA is a humanitarian logistics initiative leveraging AI and IoT technologies to
            optimize resource distribution in Vietnam, spanning hardware (edge AIoT) to software,
            databases, and ML algorithms:{" "}
          </p>
          <ul className="muted">
            <li>
              Designed custom PCB/PCBA with ESP32-CAM for embedded Edge AI computer vision on
              drones to detect people from the air.
            </li>
            <li>
              Implemented RFID, temperature-humidity sensors, and ESP32/ESP8266 MCUs as a demo
              system for inbound, inventory, and outbound warehouse management.
            </li>
            <li>
              Developed a software stack (Flask, Redis, PostgreSQL) for citizen and admin access,
              integrating K-Means clustering to allocate relief supplies more effectively, with a
              pilot case in Ho Chi Minh City.
            </li>
          </ul>
          ...
          <div className="quick-grid" style={{ marginTop: "16px" }}>
            <div className="quick-card">
              <strong>Role</strong>
              <div className="muted">
                Firmware | Edge AI | Software Developer <br /> <strong>Team SAVINA</strong>
              </div>
            </div>
            <div className="quick-card">
              <strong>Award</strong>
              <div className="muted">2nd Runner-up · HumanLog Hackathon 2025</div>
            </div>
            <div className="quick-card">
        ...
        <section id="certifications" className="content reveal" aria-labelledby="certifications-title">
          ...
          <div className=" iot-prize">
            <img
              src="../static/images/klu_hackathon/klu_cert_3.jpg"
              alt="Certification Big"
              className="gallery-thumb"
              data-large="../static/images/klu_hackathon/klu_cert_3.jpg"
            />

            <img
              src="../static/images/klu_hackathon/klu_cert_2.jpg"
              alt="Certification Small 1"
              className="gallery-thumb"
              data-large="../static/images/klu_hackathon/klu_cert_2.jpg"
            />

            <img
              src="../static/images/klu_hackathon/klu_cert_1.jpg"
              alt="Certification Small 2"
              className="gallery-thumb"
              data-large="../static/images/klu_hackathon/klu_cert_1.jpg"
            />

            <img
              src="../static/images/klu_hackathon/klu_cert_4.jpg"
              alt="Certification Tall"
              className="gallery-thumb"
              data-large="../static/images/klu_hackathon/klu_cert_4.jpg"
            />
          </div>
        </section>
        ...
        <section id="architecture" className="content reveal" aria-labelledby="arch-title">
          ...
          <div className="arch-banner">
            <img
              src="../static/images/klu_hackathon/SAVINA_System.png"
          ...
          <div className="arch" style={{ marginTop: "12px" }}>
            <div className="box device">
              ESP32S3 - ESP32-CAM
              <br />
              <span className="small-muted">RFID RC522, DHT11, Edge CV</span>
            </div>
